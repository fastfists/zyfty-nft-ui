...
export class EscrowComponent implements OnInit {
  ...
  constructor(
    ...
    private marketService: nftmarketService
  ) {}
  ...
  ngOnInit(): void {
    ...
    let p = Promise.all([
      this.escrow.tokensLeft(1),
      this.escrow.tokensLeft(2),
      this.escrow.tokensLeft(3),
      this.escrow.tokensLeft(4),
      this.escrow.getTokens(1),
      this.escrow.getTokens(2),
      this.escrow.getTokens(3),
      this.escrow.getTokens(4),
    ]);
    p.then((data) => {
